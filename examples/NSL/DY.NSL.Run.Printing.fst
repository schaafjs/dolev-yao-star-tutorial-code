...
let state_to_string b =
  ...
  | SentMsg3 s -> Some (Printf.sprintf "SentMsg3 [n_b = (%s), to = (%s)]" (bytes_to_string s.n_b) s.bob)
  | RcvdMsg3 s -> Some (Printf.sprintf "RcvdMsg3 [n_a = (%s), n_b = (%s), from = (%s)]" (bytes_to_string s.n_a) (bytes_to_string s.n_b) s.alice)
