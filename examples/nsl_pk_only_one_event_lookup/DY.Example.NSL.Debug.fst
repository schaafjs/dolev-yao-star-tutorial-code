...
let debug () : traceful (option unit)  =
  ...
  let*? (msg1_id, alice_session_id) = send_msg1_ alice_global_session_ids alice bob in 
  ...
  let*? (msg2_id, bob_session_id) = send_msg2_ bob_global_session_ids bob msg1_id in
...
//  let*? msg3_id = send_msg3 alice_global_session_ids alice alice_session_id in
  // let*? sid = prepare_msg3_ alice_global_session_ids alice msg2_id in
  // let*? msg3_id = send_msg3 alice_global_session_ids alice sid in
  let*? (msg3_id, _) = send_msg3_ alice_global_session_ids alice msg2_id in

  // Bob receive message 3
  //prepare_msg4 bob_global_session_ids bob bob_session_id msg3_id;*
  receive_msg3 bob_global_session_ids bob msg3_id;*
